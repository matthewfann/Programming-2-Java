 ...
 * This class represents the control panel for the juke box.
...
public class JukeBoxControls extends JPanel 
{
	...
	private class ComboListener implements ActionListener 
	{
		...
		/**
		 * Stops playing the current selection (if any) and resets the current
		 * selection to the one chosen.
		 */
	...
	{
		/**
		 * Stops the current selection (if any) in either case. If the play
		 * button was pressed, start playing it again.
		 */
		public void actionPerformed(ActionEvent event) 
		{
			if (current != null) 
